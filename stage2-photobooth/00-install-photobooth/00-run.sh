...
wget https://raw.githubusercontent.com/andi34/photobooth/dev/install-photobooth.sh -O files/install-photobooth.sh
...
./install-photobooth.sh -u="${FIRST_USER_NAME}" -rs
EOF
